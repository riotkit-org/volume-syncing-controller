...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodEnvironmentFromSecret) DeepCopyInto(out *PodEnvironmentFromSecret) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodEnvironmentFromSecret.
func (in *PodEnvironmentFromSecret) DeepCopy() *PodEnvironmentFromSecret {
	if in == nil {
		return nil
	}
	out := new(PodEnvironmentFromSecret)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodFilesystemSyncSpec) DeepCopyInto(out *PodFilesystemSyncSpec) {
	*out = *in
	...
	out.EnvFromSecret = in.EnvFromSecret
	return
}
